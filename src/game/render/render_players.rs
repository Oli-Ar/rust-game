        ...
        match player.number {
          ...
          2 => {
            draw_circle([0.0, 1.0, 1.0, 1.0],
                        counter_size,
                        cell_x+window_size.width/7.0-counter_size-5.0,
                        cell_y+5.0,
                        c, &mut g
            );
          },
          3 => {
            draw_circle([0.0, 0.0, 1.0, 1.0],
                        counter_size,
                        cell_x+5.0,
                        cell_y+window_size.height/7.0-counter_size-5.0,
                        c, &mut g
            );
          },
          4 => {
...
fn draw_circle(color: [f32; 4], size: f64, x_pos: f64, y_pos: f64, c: Context, g: &mut G2d) {
