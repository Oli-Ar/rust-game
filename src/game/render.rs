use crate::game::Game;
use piston_window::{rectangle, PistonWindow, Rectangle, Text, Window, WindowSettings};
        ...
        */
        ...
        while let Some(e) = window.next() {
            ...
            if self.active == false {
                ...
                && self.top_player.as_ref().unwrap().score
                    < self.game_options.board_size * self.game_options.board_size
            {
                render_board(
                    self,
                    &mut window,
